...
<div style="display: flex; flex-direction: row; justify-content: space-around;"><span>[Хостинг Rust  <<<](./HostingRust.md)</span> <span>|</span> <span>[>>> Хостинг Python Postgres](./HostingPythonPostgres.md)</span></div>
