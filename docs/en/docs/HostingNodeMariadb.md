...
<div style="display: flex; flex-direction: row; justify-content: space-around;"><span>[Hosting Node Mysql <<<](./HostingNodeMysql.md)</span> <span>|</span> <span>[>>> Hosting Node Mongo](./HostingNodeMongo.md)</span></div>
